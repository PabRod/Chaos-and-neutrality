...
- [x] table 1 - put the description of how S_ij are chosen in the text, not just table legend
  - Added a description. Perhaps enlarge?
...
- [ ] l.120 - what about heteroclinic orbits?
  - Heteroclinic orbits are highly unlikely to be found on a system like this
- [ ]fig. 3 - explain why you stop at epsilon=-0.8
  - Check if 0.2 is width or semiwidth
...
- [ ] l.163 - how do we know these are the asymptotic dynamics?  complex systems can have long transients
  - We don't know. Nobody can. This is a fundamental problem.
...
- [x] eq. 20 - also assumes equal r and K
