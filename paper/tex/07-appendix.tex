...
\subsection{Results for different food webs}
\label{subsec:GeneralResults}
In the main body of the paper we focused our attention in a food webs consisting of $12$ prey and $8$ predator species. In this section we show the results of the same analysis for food webs of different sizes.
