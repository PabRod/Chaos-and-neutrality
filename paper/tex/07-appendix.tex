...
The numerical experiment was repeated for food webs of different sizes. Only the results for the web with $10$ predator and $15$ prey species was fully shown in the main body of the paper.

In this section, we show our complete set of results.

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1\columnwidth]{2-3p.png}
	\end{center}
	\caption{Detailed results for 2 predator and 3 prey species.}
	\label{fig:2-3}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1\columnwidth]{4-6p.png}
	\end{center}
	\caption{Detailed results for 4 predator and 6 prey species.}
	\label{fig:4-6}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1\columnwidth]{6-9p.png}
	\end{center}
	\caption{Detailed results for 6 predator and 9 prey species.}
	\label{fig:6-9}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1\columnwidth]{8-12p.png}
	\end{center}
	\caption{Detailed results for 8 predator and 12 prey species.}
	\label{fig:8-12}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1\columnwidth]{10-15p.png}
	\end{center}
	\caption{Detailed results for 10 predator and 15 prey species.}
	\label{fig:10-15}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1\columnwidth]{12-18p.png}
	\end{center}
	\caption{Detailed results for 12 predator and 18 prey species.}
	\label{fig:12-18}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1\columnwidth]{14-21p.png}
	\end{center}
	\caption{Detailed results for 14 predator and 21 prey species.}
	\label{fig:14-21}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1\columnwidth]{16-24p.png}
	\end{center}
	\caption{Detailed results for 16 predator and 24 prey species.}
	\label{fig:16-24}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1\columnwidth]{18-27p.png}
	\end{center}
	\caption{Detailed results for 18 predator and 27 prey species.}
	\label{fig:18-27}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1\columnwidth]{20-30p.png}
	\end{center}
	\caption{Detailed results for 20 predator and 30 prey species.}
	\label{fig:20-30}
\end{figure}
