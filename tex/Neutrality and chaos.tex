...
Most of the previously mentioned theories involve competition only, whereas our model includes predation. It is known that the inclusion of a multi-species predation trophic level increases the probability of chaos \cite{Dakos2009b}, and may thus contribute to increase the number of coexisting species. In the present paper we explore the links between the heterogeneity at the competition level of a two trophic levels model and the type of long term dynamics exhibited. Our simulations show that the likelihood of chaotic dynamics increases when heterogeneity at the competitors' trophic level is minimal. That is, that neutrality in combination with multiple predators may promote chaos.
