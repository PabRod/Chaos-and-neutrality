...
\label{eq:RosMac2levels}
	\begin{cases}
	\dot{P} = r(P) P - g(P) P C % = r P \left( 1 - \frac{P}{K} \right) - g C \frac{P}{P + H}
	\\ 
	\dot{C} = - l C + e g(P) C P % = - l C + e g C \frac{P}{P + H}
	\end{cases}
\end{eqnarray}
	...
	\begin{center}
		\resizebox{\columnwidth}{!}{
			\begin{tabular}{|c|c|c|} \hline 
				...
				\hline 
				Two species & eq. \ref{eq:LotkaVolterra} & eq. \ref{eq:RosMac2classic} \\ 
				\hline 
				Multispecies & eq. \ref{eq:LotkaVolterraMulti} & eq. \ref{eq:RosMacMulti}  \\
			\hline  \end{tabular}}
	\end{center}
	\caption{Summary table with the different types of predation models.}
\end{table}
