...
\subsection{Generalized Rosenzweig-MacArthur model}
\label{subsec:GeneralizedRosMacModel}

%TODO Write appendix subsection
\todo[inline, color = blue!25]{Write it}
